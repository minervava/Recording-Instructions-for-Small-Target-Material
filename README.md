...
<div style="display: flex; gap: 0px;">
  <figure style="width:50%; text-align: center;">
    <img src="fig_ApertureFocus.png" alt="調焦環與光圈環示意圖" style="width:100%;">
    <figcaption>調焦環與光圈環示意圖</figcaption>
  </figure>
  <figure style="width:50%; text-align: center;">
    <img src="fig_ApertureFocusC.jpg" alt="手動旋轉以調整焦距及光圈" style="width:100%;">
    <figcaption>手動旋轉以調整焦距及光圈。</figcaption>
  </figure>
</div>
